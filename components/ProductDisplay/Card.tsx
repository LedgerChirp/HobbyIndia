			...
			<div className="">
				<div className="sm:grid sm:grid-cols-2">
					<div className="flex flex-col items-center sm:items-start sm:m-auto sm:w-full sm:h-full sm:justify-center text-gray-700 sm:pl-10 ">
						<p className="font-medium">Learn new antique jharokha art with</p>
						<h2 className="text-3xl font-bold text-center w-[80%] sm:w-full sm:text-start">
							Our pre-marketed jharokha design
						</h2>
							...
							return (
								...
								>
									<Image
										...
										height={200}
									/>
									<p className="text-center bg-[#700165] text-white w-[90%] sm:w-full rounded-b-2xl p-1">
										{item.title}
									</p>
								</div>
							);
						...
						return (
							<div key={item.id} className="flex flex-col items-center w-full">
								<Image
									...
									height={200}
								/>
								<p className="text-center bg-[#700165] text-white w-[90%] sm:w-full lg:w-[90%] rounded-b-2xl p-1">
									{item.title}
								</p>
							</div>
						);
